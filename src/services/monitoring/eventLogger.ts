...
export class EventLogger {
   ...
   */
  static logNavigation(_event: NavigationEvent) {
   ...
   */
  static logPerformance(_event: PerformanceEvent) {
   ...
   */
  static logError(_event: ErrorEvent) {
   ...
   */
  static logCanvasEvent(_action: string, _data: Record<string, unknown> = {}) {
   ...
   */
  static logTiming(_name: string, _duration: number, _context?: string) {
